...
create_pixelated_button("STAGE 3", "#0067ca", "#e2ffff", vertical_offset=0, font_filename="pixelated.ttf", width=1100, height=378,font_size=330,border_width=20)
...
# create_pixelated_button("WORLD 2", "#da3800", "#e2ffff", vertical_offset=0, font_filename="pixelated.ttf", width=1100, height=378,font_size=330,border_width=20)
# create_pixelated_button("WORLD 3", "#0067ca", "#e2ffff", vertical_offset=0, font_filename="pixelated.ttf", width=1100, height=378,font_size=330,border_width=20)
